...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    <div class="page login-page" style="background-image: url('<?php echo e(asset('/public/img/bg.jpg')); ?>') ; background-repeat: no-repeat; background-size: cover; ">
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          ...
          <div class="copyrights text-center">
            <p><?php echo e(trans('file.Developed By')); ?> <a href="http://ovisioneg.com" class="external">OVISION</a></p>
          </div>
        </div>
      </div>
    </div>
