            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.add_service')); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4" hidden >
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Type')); ?> * </label>
                                ...
                                <div class="col-md-4" hidden>
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Barcode Symbology')); ?> * </label>
                                        <div class="input-group">
...
<input type="hidden" name="category_id" value="0">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.service_price')); ?> * </label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.service_details')); ?></label>
                            ...
                            <div class="form-group">
                                <input type="button" value="<?php echo e(trans('file.submit')); ?>" id="submit-btn" class="btn btn-lg btn-primary pull-left">
                            </div>
                        </form>
                    </div>
                </div>
