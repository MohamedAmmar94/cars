                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<select required name="type" class="selectpicker form-control" data-live-search="true" id="type" data-live-search-style="begins" title=" Work Oreder Type"}} ..">
												<option value="PM" <?php echo e(($lims_quotation_data->type =="pm") ? 'selected' : ""); ?> >PM</option>
												<option value="CM"  <?php echo e(($lims_quotation_data->type =="CM") ? 'selected' : ""); ?>>CM</option>
												<option value="RF" <?php echo e(($lims_quotation_data->type =="RF") ? 'selected' : ""); ?>>RF</option>
											</select>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class=" form-control" name="mill_age" value="<?php echo e($lims_quotation_data->mill_age ?? ""); ?>" required>
										</div>
									</div>
