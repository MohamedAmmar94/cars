...
<section>
    <div class="container-fluid">
        <?php if(in_array("products-add", $all_permission)): ?>
            <a href="<?php echo e(route('services.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(__('file.add_service')); ?></a>
...
<div id="product-details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">تفاصيل الخدمة </h5>
...
<script>
    ...
    $("ul#services #services-list-menu").addClass("active");
    ...
    function productDetails(product, imagedata) {
        ...
        htmltext = '<p><strong><?php echo e(trans("file.name")); ?>: </strong>'+product[1]+'</p><p><strong><?php echo e(trans("file.Code")); ?>: </strong>'+product[2]+ '</p><p><strong><?php echo e(trans("file.Price")); ?>: </strong>'+product[7]+'</p><p><strong><?php echo e(trans("file.service_details")); ?>: </strong></p>'+product[11];
        ...
        if(product[0] == 'combo') {
            ...
            $(product_list).each(function(i) {
                $.get('services/getdata/' + product_list[i], function(data) {
                    var newRow = $("<tr>");
                    var cols = '';
                        ...
                        if(user_verified == '1') {
                            ...
                            $(':checkbox:checked').each(function(i){
                                if(i){
                                    ...
                                    product_id[i-1] = product_data[11];
                                }
                            });
