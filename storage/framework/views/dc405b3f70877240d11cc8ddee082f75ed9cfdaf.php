            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.add_workorder')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => 'workorder.store', 'method' => 'post', 'files' => true, 'id' => 'quotation-form']); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a target="_blank" href="<?php echo e(route('customer.create')); ?>" class="btn btn-sm btn-info" ><i class="fa fa-plus-circle"></i></a>
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="<?php echo e(trans('file.choose')." ".trans('file.customer')); ?> ..">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a target="_blank" href="<?php echo e(route('cars.create')); ?>" class="btn btn-sm btn-info" ><i class="fa fa-car"></i></a>
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											<label><?php echo e(trans('file.workorder_type')); ?>*</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label><?php echo e(trans('file.car_millage')); ?> *</label>
