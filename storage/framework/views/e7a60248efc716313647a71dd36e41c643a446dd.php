            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Update Service Product')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.service_name')); ?> * </label>
                                ...
                                <div id="digital" class="col-md-4" hidden>
                                    <div class="form-group">
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Cost')); ?> * </label>
                                ...
                                <div class="col-md-4" >
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Price')); ?> *</label>
                                ...
                                <div id="alert-qty" class="col-md-4" hidden>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12"> 
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Services Details')); ?></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="button" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary pull-left"  id="submit-btn">
                                    </div>
                                </div>
                            </div>
                        </form>
