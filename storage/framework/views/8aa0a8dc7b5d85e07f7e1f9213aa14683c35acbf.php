                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
								...
								<tr>
									<td><?php echo e(trans('file.service')); ?></td>
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("service-index", $all_permission)): ?>
													<input type="checkbox" value="1" id="service-index" name="service-index" checked />
												<?php else: ?>
													<input type="checkbox" value="1" id="service-index" name="service-index" />
												<?php endif; ?>
												<label for="service-index"></label>
											</div>
										</div>
									</td>
									<td class="text-center">
										<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("service-add", $all_permission)): ?>
													<input type="checkbox" value="1" id="service-add" name="service-add" checked>
												<?php else: ?>
													<input type="checkbox" value="1" id="service-add" name="service-add">
												<?php endif; ?>
									...
									<td class="text-center">
										<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("service-edit", $all_permission)): ?>
													<input type="checkbox" value="1" id="service-edit" name="service-edit" checked />
												<?php else: ?>
													<input type="checkbox" value="1" id="service-edit" name="service-edit" />
												<?php endif; ?>
												<label for="service-edit"></label>
											</div>
										</div>
									</td>
									<td class="text-center">
										<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("service-delete", $all_permission)): ?>
													<input type="checkbox" value="1" id="service-delete" name="service-delete" checked />
												<?php else: ?>
													<input type="checkbox" value="1" id="service-delete" name="service-delete" />
												<?php endif; ?>
												<label for="service-delete"></label>
											</div>
										</div>
									</td>
								</tr>
						        ...
						        <tr>
						            <td><?php echo e(trans('file.stockorders')); ?></td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("stockorder-index", $all_permission)): ?>
								                <input type="checkbox" value="1" id="stockorder-index" name="stockorder-index" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="stockorder-index" name="stockorder-index">
								                <?php endif; ?>
								                <label for="stockorder-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("stockorder-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="stockorder-add" name="stockorder-add" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="stockorder-add" name="stockorder-add">
								                <?php endif; ?>
								                <label for="stockorder-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("stockorder-edit", $all_permission)): ?>
								                <input type="checkbox" value="1" id="stockorder-edit" name="stockorder-edit" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="stockorder-edit" name="stockorder-edit">
								                <?php endif; ?>
								                <label for="stockorder-edit"></label>
								            </div>
						            	</div>
						            </td>
								...
								<tr>
									<td><?php echo e(trans('file.workorder')); ?></td>
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("workorder-index", $all_permission)): ?>
									...
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("workorder-add", $all_permission)): ?>
									...
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("workorder-edit", $all_permission)): ?>
									...
									<td class="text-center">
										<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("workorder-delete", $all_permission)): ?>
								...
								<tr>
									<td><?php echo e(trans('file.cars')); ?></td>
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("cars-index", $all_permission)): ?>
													<input type="checkbox" value="1" id="cars-index" name="cars-index" checked>
												<?php else: ?>
													<input type="checkbox" value="1" id="cars-index" name="cars-index">
												<?php endif; ?>
												<label for="cars-index"></label>
											</div>
										</div>
									</td>
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("cars-add", $all_permission)): ?>
													<input type="checkbox" value="1" id="cars-add" name="cars-add" checked>
												<?php else: ?>
													<input type="checkbox" value="1" id="cars-add" name="cars-add">
												<?php endif; ?>
												<label for="cars-add"></label>
											</div>
										</div>
									</td>
									<td class="text-center">
										<div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("cars-edit", $all_permission)): ?>
													<input type="checkbox" value="1" id="cars-edit" name="cars-edit" checked>
												<?php else: ?>
													<input type="checkbox" value="1" id="cars-edit" name="cars-edit">
												<?php endif; ?>
												<label for="cars-edit"></label>
											</div>
										</div>
									</td>
									<td class="text-center">
										<div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
											<div class="checkbox">
												<?php if(in_array("cars-delete", $all_permission)): ?>
													<input type="checkbox" value="1" id="cars-delete" name="cars-delete" checked>
												<?php else: ?>
													<input type="checkbox" value="1" id="cars-delete" name="cars-delete">
												<?php endif; ?>
												<label for="cars-delete"></label>
											</div>
										</div>
									</td>
								</tr>
