                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" id="biller-id" data-live-search-style="begins" title="أختر الشخص المستلم ..">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="أختر العميل ...">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="أختر المنتجات ...." class="form-control" />
                                        </div>
                                    </div>
                                </div>
		                        <div class="row mt-5">
