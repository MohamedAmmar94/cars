    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="brand-text float-left mt-4">
                <h3><?php echo e(trans('file.workorder')); ?> </h3>
            </div>
        </div>
    </div>
</div>
<section>
    <div class="container-fluid">
        <?php if(in_array("workorder-add", $all_permission)): ?>
            <a href="<?php echo e(route('workorder.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.add_workorder')); ?></a>
        <?php endif; ?>
    </div>
        ...
        <table id="quotation-table" class="table quotation-list">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.dispatch_status')); ?></th>
                    <th><?php echo e(trans('file.workorder_status')); ?></th>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('workorder.edit', ['id' => $quotation->id])); ?>"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>

                                <li class="divider"></li>
                                <?php if(in_array("workorder-delete", $all_permission)): ?>
                                <?php echo e(Form::open(['route' => ['workorder.destroy', $quotation->id], 'method' => 'DELETE'] )); ?>
                                ...
                                <?php endif; ?>
								 <?php if(in_array("workorder-edit", $all_permission)): ?>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('workorder.cancel', ['id' => $quotation->id])); ?>"> <?php echo e(trans('file.cancel')); ?></a>
                                </li>
                                <?php endif; ?>
								 <?php if(in_array("workorder-edit", $all_permission)): ?>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('workorder.closed', ['id' => $quotation->id])); ?>"> <?php echo e(trans('file.closed')); ?></a>
                                </li>
                                <?php endif; ?>
                            </ul>
                        </div>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(trans('file.workorder_details')); ?></i>
                </div>
            </div>
        </div>
