        ...
        <table id="category-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.category_name')); ?></th>
          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label><?php echo e(trans('file.category_name')); ?> *</label>
                    <?php echo e(Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'ادخل اسم التصميف'))); ?>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <?php echo e(Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => 'تصنيف رئيسي '])); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="parent_id" class="form-control selectpicker" id="parent">
                    <option value=""> <?php echo e(trans('file.parent')); ?></option>
