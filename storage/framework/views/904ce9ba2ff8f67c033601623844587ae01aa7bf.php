...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo asset('public/css/style.blue.css') ?>" id="theme-stylesheet" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo asset('public/fonts/Tajawal/font-Tajawal.css') ?>">
    ...
    <link rel="stylesheet" href="<?php echo asset('public/css/custom-blue.css') ?>" type="text/css" id="custom-style">
  </head>
  ...
  <body onload="myFunction()">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <?php
                ...
                <?php
                $index_permission = DB::table('permissions')->where('name', 'workorder-index')->first();
                ...
                <?php if($index_permission_active): ?>
                    <li><a href="#workorder" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span><?php echo e(trans('file.workorder')); ?></span><span></a>
                        <ul id="workorder" class="collapse list-unstyled ">
                            <li id="workorder-list-menu"><a href="<?php echo e(route('workorder.index')); ?>"><?php echo e(trans('file.workorder_list')); ?></a></li>
                            <?php
                            $add_permission = DB::table('permissions')->where('name', 'workorder-add')->first();
                            ...
                            <?php if($add_permission_active): ?>
                                <li id="quotation-create-menu"><a href="<?php echo e(route('workorder.create')); ?>"><?php echo e(trans('file.add_workorder')); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <?php
                $index_permission = DB::table('permissions')->where('name', 'stockorder-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                    ['permission_id', $index_permission->id],
                    ['role_id', $role->id]
                ])->first();
                ?>
                <?php if($index_permission_active): ?>
                    <li><a href="#stockorder" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span><?php echo e(trans('file.stockorders')); ?></span></a>
                        <ul id="stockorder" class="collapse list-unstyled ">
                            <li id="stockorder-list-menu"><a href="<?php echo e(route('stockorders.index')); ?>"><?php echo e(trans('file.Stockorders_list')); ?></a></li>
                ...
                ?>
                <?php if($index_permission_active || $gift_card_permission_active || $coupon_permission_active): ?>
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.product')); ?></span></a>
                <ul id="product" class="collapse list-unstyled ">
                  <li id="category-menu"><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('file.categories')); ?></a></li>
                  <?php if($index_permission_active): ?>
                ...
                <?php
                $role = DB::table('roles')->find(Auth::user()->role_id);
                $index_permission = DB::table('permissions')->where('name', 'service-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                    ['permission_id', $index_permission->id],
                    ['role_id', $role->id]
                ])->first();
                ...
                <li><a href="#services" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.services')); ?></span></a>
                    <ul id="services" class="collapse list-unstyled ">
                        <?php if($index_permission_active): ?>
                            <li id="services-list-menu"><a href="<?php echo e(route('services.index')); ?>"><?php echo e(__('file.services_list')); ?></a></li>
                            <?php
                            $add_permission = DB::table('permissions')->where('name', 'service-add')->first();
                            $add_permission_active = DB::table('role_has_permissions')->where([
                                ['permission_id', $add_permission->id],
                                ['role_id', $role->id]
                            ])->first();
                            ?>
                            <?php if($add_permission_active): ?>
                                <li id="services-create-menu"><a href="<?php echo e(route('services.create')); ?>"><?php echo e(__('file.add_service')); ?></a></li>
                            <?php endif; ?>
                        <?php endif; ?>
            ...
            <?php
                ...
                $index_permission2 = DB::table('permissions')->where('name', 'purchase-return-index')->first();
                $index_permission_active2 = DB::table('role_has_permissions')->where([
                    ['permission_id', $index_permission2->id],
                    ['role_id', $role->id]
                ])->first();

            ?>
                <?php if($index_permission_active || $index_permission_active2): ?>
              ...
              ?>
                <?php if($department_active || $index_employee_active || $attendance_active || $payroll_active): ?>
              ...
              <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span><?php echo e(trans('file.People')); ?></span></a>
                <ul id="people" class="collapse list-unstyled ">
                  ...
                  <?php
                  $index_permission = DB::table('permissions')->where('name', 'cars-index')->first();
                  $index_permission_active = DB::table('role_has_permissions')->where([
                      ['permission_id', $index_permission->id],
                      ['role_id', $role->id]
                  ])->first();
                  ?>
                  <?php if($index_permission_active): ?>
                      <li id="cars-list-menu"><a href="<?php echo e(route('cars.index')); ?>"><?php echo e(trans('file.CustomerCars List')); ?></a></li>
                      <?php
                      $add_permission = DB::table('permissions')->where('name', 'cars-add')->first();
                      $add_permission_active = DB::table('role_has_permissions')->where([
                          ['permission_id', $add_permission->id],
                          ['role_id', $role->id]
                      ])->first();
                      ?>
                      <?php if($add_permission_active): ?>
                          <li id="cars-create-menu"><a href="<?php echo e(route('cars.create')); ?>"><?php echo e(trans('file.add_CustomerCar')); ?></a></li>
                      <?php endif; ?>
                  <?php endif; ?>
    ...
    <div class="page" style="background-image: url("<?php echo e(asset('img/bg.jpg')); ?>");">
                    ...
                    ?>
                      <div class="row">
                        ...
                        <div class="col-md-6 form-group" hidden>
                            ...
                            <input type="hidden" value="1" name="warehouse_id">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="https://ovisioneg.com" class="external">OVISION</a></p>
            </div>
          </div>
        </div>
      </footer>
