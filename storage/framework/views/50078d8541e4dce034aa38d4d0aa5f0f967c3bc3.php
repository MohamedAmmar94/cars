            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.add_car')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => 'cars.store', 'method' => 'post', 'files' => true]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.chassis')); ?> <strong>* </strong> </label>
                                        <input type="text" name="chassis" value="<?php echo e(old('chassis')); ?>" required class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mileage" value="<?php echo e(old('mileage')); ?>" class="form-control">
                                    <?php if($errors->has('mileage')): ?>
                                        <span>
                                       <strong><?php echo e($errors->first('mileage')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="plate" required value="<?php echo e(old('plate')); ?>" class="form-control">
