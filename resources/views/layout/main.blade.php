            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <?php
                ...
                @if($index_permission_active)
                    <li><a href="#workorder" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>{{trans('file.workorder')}}</span><span></a>
                        <ul id="workorder" class="collapse list-unstyled ">
                            <li id="workorder-list-menu"><a href="{{route('workorder.index')}}">{{trans('file.workorder_list')}}</a></li>
                            <?php
                            ...
                            @if($add_permission_active)
                                <li id="quotation-create-menu"><a href="{{route('workorder.create')}}">{{trans('file.add_workorder')}}</a></li>
                            @endif
                        </ul>
                    </li>
                @endif
                ...
                ?>
                @if($index_permission_active)
                    <li><a href="#stockorder" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>{{trans('file.stockorders')}}</span></a>
                        <ul id="stockorder" class="collapse list-unstyled ">
                            <li id="stockorder-list-menu"><a href="{{route('stockorders.index')}}">{{trans('file.Stockorders_list')}}</a></li>
                ...
                ?>
                @if($index_permission_active || $gift_card_permission_active || $coupon_permission_active)
...
{{--                            <li id="delivery-menu"><a href="{{route('delivery.index')}}">{{trans('file.Delivery List')}}</a></li>--}}
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{__('file.product')}}</span></a>
                ...
                <li><a href="#services" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{__('file.services')}}</span></a>
                    <ul id="services" class="collapse list-unstyled ">
                        @if($index_permission_active)
                            <li id="services-list-menu"><a href="{{route('services.index')}}">{{__('file.services_list')}}</a></li>
                            <?php
                            ...
                            ?>
                            @if($add_permission_active)
                                <li id="services-create-menu"><a href="{{route('services.create')}}">{{__('file.add_service')}}</a></li>
                            @endif
                        @endif
...
{{--                  <li id="purchase-import-menu"><a href="{{url('purchases/purchase_by_csv')}}">{{trans('file.Import Purchase By CSV')}}</a></li>--}}
            ...
            ?>
                @if($index_permission_active || $index_permission_active2)
...
{{--                      <li id="holiday-menu"><a href="{{route('holidays.index')}}">{{trans('file.Holiday')}}</a></li>--}}
              ...
              <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span>{{trans('file.People')}}</span></a>
                <ul id="people" class="collapse list-unstyled ">
                  ...
                  ?>
                  @if($index_permission_active)
                      <li id="cars-list-menu"><a href="{{route('cars.index')}}">{{trans('file.CustomerCars List')}}</a></li>
                      <?php
                      ...
                      ?>
                      @if($add_permission_active)
                          <li id="cars-create-menu"><a href="{{route('cars.create')}}">{{trans('file.add_CustomerCar')}}</a></li>
                      @endif
                  @endif
...
{{--                      </li>--}}
    ...
    <div class="page" style="background-image: url("{{asset('img/bg.jpg')}}");">
...
{{--                            </select>--}}
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <a href="https://ovisioneg.com" class="external">OVISION</a></p>
            </div>
          </div>
        </div>
      </footer>
