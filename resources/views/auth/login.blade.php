...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    <div class="page login-page" style="background-image: url('{{asset('/public/img/bg.jpg')}}') ; background-repeat: no-repeat; background-size: cover; ">
      <div class="container">
...
{{--            <p>{{trans('file.Do not have an account?')}}</p><a href="{{url('register')}}" class="signup">{{trans('file.Register')}}</a>--}}
          ...
          <div class="copyrights text-center">
            <p>{{trans('file.Developed By')}} <a href="http://ovisioneg.com" class="external">OVISION</a></p>
          </div>
        </div>
      </div>
    </div>
