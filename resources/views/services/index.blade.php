...
<section>
    <div class="container-fluid">
        @if(in_array("products-add", $all_permission))
            <a href="{{route('services.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.add_service')}}</a>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        htmltext = '<p><strong>{{trans("file.name")}}: </strong>'+product[1]+'</p><p><strong>{{trans("file.Code")}}: </strong>'+product[2]+ '</p><p><strong>{{trans("file.Price")}}: </strong>'+product[7]+'</p><p><strong>{{trans("file.service_details")}}: </strong></p>'+product[11];
