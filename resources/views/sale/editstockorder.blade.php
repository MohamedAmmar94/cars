            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.completeStock_order')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => ['sale.updatestockorder', $lims_sale_data->id], 'method' => 'post', 'files' => true, 'id' => 'payment-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly class="form-control" value="{{$lims_sale_data->customer->name}}">
                                            <div hidden>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly class="form-control" value="{{$lims_sale_data->customercar->chassis}}">
...
{{--                                                        <th><i class="dripicons-trash"></i></th>--}}
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td hidden><input type="number" class="form-control qty" name="qty[]" value="{{$product_sale->qty}}" step="any" required/></td>
