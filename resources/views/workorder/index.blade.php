...
<section>
    <div class="container-fluid">
        @if(in_array("workorder-add", $all_permission))
            <a href="{{route('workorder.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.add_workorder')}}</a>
        @endif
    </div>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="{{ route('workorder.edit', ['id' => $quotation->id]) }}"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                @endif

                                <li class="divider"></li>
                                @if(in_array("workorder-delete", $all_permission))
                                {{ Form::open(['route' => ['workorder.destroy', $quotation->id], 'method' => 'DELETE'] ) }}
                                <li>
                                ...
                                @endif
								 @if(in_array("workorder-edit", $all_permission))
                                <li>
                                    <a class="btn btn-link" href="{{ route('workorder.cancel', ['id' => $quotation->id]) }}"> {{trans('file.cancel')}}</a>
                                </li>
                                @endif
								 @if(in_array("workorder-edit", $all_permission))
                                <li>
