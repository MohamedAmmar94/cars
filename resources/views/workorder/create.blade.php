            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.add_workorder')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'workorder.store', 'method' => 'post', 'files' => true, 'id' => 'quotation-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a target="_blank" href="{{ route('customer.create') }}" class="btn btn-sm btn-info" ><i class="fa fa-plus-circle"></i></a>
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="{{ trans('file.choose')." ".trans('file.customer')}} ..">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a target="_blank" href="{{ route('cars.create') }}" class="btn btn-sm btn-info" ><i class="fa fa-car"></i></a>
