...
class RoleController extends Controller
{
    ...
    public function setPermission(Request $request)
    {
        ...
        if($request->has('service-index')){
            $permission = Permission::firstOrCreate(['name' => 'service-index']);
            if(!$role->hasPermissionTo('service-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('service-index');
        ...
        if($request->has('service-edit')){
            ...
            $role->revokePermissionTo('service-edit');
        ...
        if($request->has('stockorder-index')){
            $permission = Permission::firstOrCreate(['name' => 'stockorder-index']);
            if(!$role->hasPermissionTo('stockorder-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('stockorder-index');



        if($request->has('stockorder-edit')){
            $permission = Permission::firstOrCreate(['name' => 'stockorder-edit']);
            if(!$role->hasPermissionTo('stockorder-edit')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('stockorder-edit');
        ...
        if($request->has('cars-index')){
            $permission = Permission::firstOrCreate(['name' => 'cars-index']);
            if(!$role->hasPermissionTo('cars-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('cars-index');

        if($request->has('cars-add')){
            $permission = Permission::firstOrCreate(['name' => 'cars-add']);
            if(!$role->hasPermissionTo('cars-add')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('cars-add');

        if($request->has('cars-edit')){
            $permission = Permission::firstOrCreate(['name' => 'cars-edit']);
            if(!$role->hasPermissionTo('cars-edit')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('cars-edit');

        if($request->has('cars-delete')){
            $permission = Permission::firstOrCreate(['name' => 'cars-delete']);
            if(!$role->hasPermissionTo('cars-delete')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('cars-delete');
