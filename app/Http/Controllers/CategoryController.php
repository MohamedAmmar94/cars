...
//                $nestedData['image']="";
                ...
                if(config('currency_position') == 'prefix')
                    $nestedData['stock_worth'] = "<span dir='ltr' >".config('currency').' '.$total_price.' / '.config('currency').' '.$total_cost."</span>";
                else
                    $nestedData['stock_worth'] = "<span dir='ltr' >".$total_price.' '.config('currency').' / '.$total_cost.' '.config('currency')."</span>";
